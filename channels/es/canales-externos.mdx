...
- **Meta** (Messenger, Instagram, WhatsApp) → [Cómo Integrarse con Meta](/workspaces/docs/integration-guides/es/como-integrarse-con-meta.mdx)
- **Freshchat** (integración URL de callback) → [Cómo Integrarse con Freshchat](/workspaces/docs/integration-guides/es/como-integrarse-con-freshchat.mdx)
- **Zendesk** (WhatsApp, Messenger, Instagram) → [Cómo Integrarse con Zendesk](/workspaces/docs/integration-guides/es/como-integrarse-con-zendesk.mdx)
