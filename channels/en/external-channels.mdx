...
- **Meta** (Messenger, Instagram, WhatsApp) → [How to Integrate with Meta](/workspaces/docs/integration-guides/en/how-to-integrate-to-meta.mdx)  
- **Freshchat** (Callback URL integration) → [How to Integrate with Freshchat](/workspaces/docs/integration-guides/en/how-to-integrate-to-freshchat.mdx)  
- **Zendesk** (WhatsApp, Messenger, Instagram) → [How to Integrate with Zendesk](/workspaces/docs/integration-guides/en/how-to-integrate-to-zendesk.mdx)  
