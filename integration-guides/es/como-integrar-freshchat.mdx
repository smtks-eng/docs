  ...
  <Step title="Obtener API Key y Base URL">
    ...
    **Pasos**
    ...
    3. Dentro de esta sección, selecciona <strong>API Settings</strong>.
       ![Paso 4 - Freshchat](/images/integration-guides/how-to-integrate-freshchat/fresh4.png)

    4. Aquí podrás ver y copiar:  
       * <strong>API Key</strong>  
       * <strong>Base URL</strong> (que indica la región o entorno donde está alojada tu cuenta).  
         ![Paso 5 - Freshchat](/images/integration-guides/how-to-integrate-freshchat/fresh5.png)
  ...
  <Step title="Configurar Webhook y Obtener Public Key">
    ...
    **Pasos**
    ...
    1. Sigue en la misma sección de <strong>API Settings</strong> dentro de <strong>Marketplace and Integrations</strong>, debemos seleccionar <strong>Conversation Webhooks:</strong>
       ![Paso 6 - Freshchat](/images/integration-guides/how-to-integrate-freshchat/fresh6.png)

    2. Haz clic en el botón <strong>Enable</strong>, si aún no lo has activado.
       ![Paso 7 - Freshchat](/images/integration-guides/how-to-integrate-freshchat/fresh7.png)
    ...
    3. Una vez habilitada la sección, en la primera caja de texto *Webhook*, pega esta URL:
        ...
        ```
        ![Paso 8 - Freshchat](/images/integration-guides/how-to-integrate-freshchat/fresh8.png)

    4. Al activar el webhook, Freshchat te mostrará una <strong>Public Key</strong> que debes copiar en la seccion *Authentication*. Esta clave será necesaria para verificar que los mensajes vienen realmente de Freshchat.
        ![Paso 9 - Freshchat](/images/integration-guides/how-to-integrate-freshchat/fresh9.png)
