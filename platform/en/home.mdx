...
language: en
icon: "chart-simple"
description: "Once your agent is live and operational, the Dashboard becomes your central hub for monitoring its real-time performance and activity. This section provides a clear overview of how your agent interacts with users, how effective its responses are, and when it is most frequently used."
---
