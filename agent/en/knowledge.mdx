...
It works similarly, with one key difference: it improves either the question _or_ the answer individually, allowing you to fine-tune each part separately.
