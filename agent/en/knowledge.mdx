...
The Knowledge page is organized into tabs. The **FAQs** tab is where you manage your frequently asked questions, and the **Glossaries** tab is where you define terms and definitions for your agent.
...
The **Glossaries** tab lets you create collections of terms and definitions that your agent can reference during conversations. This ensures your agent uses consistent, accurate terminology — whether it's product names, industry jargon, acronyms, or internal vocabulary.

Glossaries are organized with a sidebar for navigation and a main panel for managing entries. You can:

- **Create multiple glossaries** to group terms by category
- **Add entries manually** with a term and its definition
- **Import entries from documents** (PDF, DOCX, TXT, CSV) using AI extraction
- **Search and filter** entries across all glossaries

<Tip>
  For a complete guide on creating, managing, and importing glossaries, see the dedicated [Glossaries](/agent/en/glossaries) page.
</Tip>
