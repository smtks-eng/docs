...
| Módulo | Descripción |
|---|---|
| **Inicio** | Resumen general y métricas clave de tu agente |
| **Hotspots** | Temas y problemas principales clasificados por puntaje de prioridad |
| **Recomendaciones** | Sugerencias generadas por IA para mejorar tu agente |
| **Escalaciones** | Datos sobre conversaciones que fueron escaladas a agentes humanos |
| **Rendimiento del Live Chat** | Métricas de rendimiento de tus operaciones de chat en vivo / centro de contacto |
| **Facturación** | Resumen de uso y facturación |
