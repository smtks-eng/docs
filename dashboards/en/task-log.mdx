...
- **Tool name** — which skill or tool was called. For **custom tools**, the custom tool's own name is displayed; for **predefined (builtin) tools**, the predefined tool name is shown.
