...
| Module | Description |
|---|---|
| **Home** | General overview and key metrics for your agent |
| **Hotspots** | Top topics and issues ranked by priority score |
| **Recommendations** | AI-generated suggestions to improve your agent |
| **Escalations** | Data on conversations that were escalated to human agents |
| **Live Chat Performance** | Performance metrics for your live chat / contact center operations |
