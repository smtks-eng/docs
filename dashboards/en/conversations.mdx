...
- **Tags:** Conversation tags assigned automatically or manually. Up to **3 tags** are shown inline; if a conversation has more than 3 tags, a **+N** badge appears indicating how many additional tags exist. Hover over the badge to see the names of the remaining tags.
- **Flag:** A flag indicator for the conversation.

<Tip>
Use the **Tags** column to quickly spot categorized conversations. The truncated view keeps the table compact while still letting you see overflow tags on hover.
</Tip>
