...
![conversations-dashboard.png](images/dashboards/conversations_dashboard/en/conversations-dashboard.png)
---
...
By clicking on the **bubble icon** in the Conversations Table, a right-side panel opens with two tabs that allow you to inspect the conversation, as well as view the summary and details of this interaction.
